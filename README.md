...
Макект находится <a href="https://www.figma.com/file/gmwg0Me1T6szwVqd7KSYL6/Kanban">здесь</a>
...
При наведении курсора на любые кликабельные элементы должен появляться курсор pointer.
